...
Component.prototype.result = function(exchange) {
...
Component.prototype.doInit = function(uri, options) {
    ...
    this.options = _.extend({ exchangePattern: 'inOnly' }, this.options);
    this.options = _.extend(this.options, strOptions);
