...
module.exports = (function() {
  ...
  function When (choice, predicate) {
    Object.defineProperties(this, {
      ...
      app: { enumerable: false, writable: true, configurable: false, value: choice.route.app },
  ...
  When.prototype = {
    to(uri, options) {
      ...
      this.processor = this.getComponentByUri(uri).createProcessor(uri, options);
