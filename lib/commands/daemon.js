...
module.exports = (function() {
  ...
  function *prepareDaemon (execution) {
    ...
    Object.defineProperty(execution.context, 'callback',  {
      enumerable: false,
      value: function() {
    ...
    yield new Promise(function(resolve, reject) {
      if (execution.opts.host) {
        ...
        reject(new Error('Cannot bind daemon to either host or socket path'));
      }
    });
  }
  ...
  function *daemonCommand (execution) {
    ...
    yield execution.context.services.scan(execution.opts.services);
  }
